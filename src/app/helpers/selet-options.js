 ...
 */
export const createSelectOptions = (list, firstParamId="id", secondParamId="nombre" ) => {
    const selectOptions = list.map( (element) => ({value: element[firstParamId], title: element[secondParamId]}) )
