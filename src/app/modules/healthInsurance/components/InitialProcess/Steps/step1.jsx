      ...
      <div className="form-row">
        ...
        <div className="form-group col-3">
          ...
          <select
            ...
            id="document_type"
            name="document_type"
            className={`form-control form-select ${formik.touched.document_type
        ...
        <div className="form-group col-3">
          ...
          <input
            type="text"
            name="identification"
            className={`form-control ${formik.touched.identification
      ...
      <div className="form-row">
        <div className="form-group col-6">
          ...
          <input
            type="text"
            name="fullname"
            className={`form-control ${formik.touched.fullname
      ...
      <div className="form-row">
        <div className="form-group col-3">
          ...
          <input
            type="text"
            name="cellphone"
            className={`form-control ${formik.touched.cellphone
        ...
        <div className="form-group col-3">
          ...
          <input
            type="date"
            name="birth_date"
            className={`form-control ${formik.touched.birth_date
        ...
        <div className="form-group col-6">
          ...
          <input
            type="text"
            name="discount_code"
            className={`form-control ${formik.touched.discount_code
