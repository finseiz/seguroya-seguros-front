    ...
    <div className="card-body container w-75">
      <div className="row">
        ...
        <div className="col p-0">
            ...
            <Field combined="names,surnames" name="Nombre" formik={formik} onEdit={onEdit} />
        ...
        <div className="col" style={{display: "grid"}}>
          ...
          <Field form="model" name="Modelo" formik={formik} onEdit={onEdit} />
          <Field form="status" name="Estado" formik={formik} onEdit={onEdit} />
          <Field form="type" name="Tipo" formik={formik} onEdit={onEdit} />
          <Field form="city" name="Ciudad de circulación" formik={formik} onEdit={onEdit} />
