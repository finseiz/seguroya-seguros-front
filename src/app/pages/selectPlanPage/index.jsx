...
function SelectPlanPage({ plans = [], selectPlan }) {
  ...
  return (
    <div className="container-fluid">
      ...
      {!selectedData ? (
        <TopInsurance onSelect={handleSelectData} insuranceList={plans} />
      ) : (
        <InsuranceDetails insurance={selectedData} selectPlan={selectPlan} />
      )}
    </div>
  );
}
