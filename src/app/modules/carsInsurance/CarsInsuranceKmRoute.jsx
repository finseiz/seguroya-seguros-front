...
import {
  CarsHomeRoute,
  CarsKmProcessDataAutorizationRoute,
  CarsKmProcessDetailsPlanRoute,
  CarsKmProcessDoneRoute,
  CarsKmProcessOtpRoute,
  CarsKmProcessSelectPlanRoute,
...
export default function CarsInsuranceKmRoute() {
  const {
    dataToSend: { email },
    progress: { initial },
    selectedPlan: { anualPrice, descriptionValues, carId },
  ...
  return (
    <Switch>
      <Route
        exact={true}
        path={CarsKmProcessSelectPlanRoute}
        component={SelectCarsPlanKm}
      />

      <Route
        exact={true}
        path={CarsKmProcessDetailsPlanRoute}
        component={KmPlanDetails}
      />
