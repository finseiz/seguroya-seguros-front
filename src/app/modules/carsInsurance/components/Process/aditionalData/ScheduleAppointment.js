...
export const ScheduleAppointment = ({ redirectRoute }) => {
  ...
  const actionsButton = [
    {
      text: "Atras",
      className:
        "btn btn-primary primary-button process__process-button px-5 mx-3",
      onClick: () => {
  ...
  return (
    <div>
      <BaseSection title="Agenda tu cita de inspección" actions={actionsButton}>
          ...
          <div className="col">
            <FormikRadioGroup
              ...
              options={[
                ...
                {
                  title: "Virtual - Tu tomas las fotos y nos las envías",
                  value: "VIRTUAL",
                },
                {
                  title: (
                    <span>
                      {" "}
                      Virtual Asistida - Te llamamos <br /> para explicarte el
                      proceso{" "}
                    </span>
                  ),
