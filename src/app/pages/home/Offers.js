...
export const Offers = () => {
  const offersList = useMemo(
    () => [
      ...
      {
        img: "/media/offers/of_2.png",
        benefits: ["Planes desde $25.000 pesos mensuales."],
        path: "/life",
      },
      // {
  ...
  return (
    <div className="container-fluid text-center">
      ...
      <div
        ...
        className="d-inline-flex flex-wrap row"
      >
          ...
          >
            <div className="bg-white home-offer__image-container">
              <NavLink to={offer.path}>
                <img src={offer.img} className="home-offer__image" />
              </NavLink>
        ...
        {/* <div className="col-4 mt-4 ">
          <div className="bg-white home-offer__image-container">
            <a
              ...
              target="_blank"
            >
              <img src="/media/offers/of3.jpg" className="home-offer__image" />
            </a>
            <ul className="py-4 text-left home-offer__text">
              {[
                "Accede a un médico especialista en cualquier horario y desde cualquier lugar.",
