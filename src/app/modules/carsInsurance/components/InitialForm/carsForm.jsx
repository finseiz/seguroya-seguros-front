...
function CarsForm() {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      console.log(
        "🚀 ~ file: carsForm.jsx ~ line 31 ~ CarsForm ~ values",
        values
      );
      ...
      if (step === 1) {
        ...
        } else history.push(CarsKmProcessSelectPlanRoute);
      }
    },
  });
      ...
      <form onSubmit={formik.handleSubmit}>
        ...
        <div className="card inital-from__box inital-from__shadow">
          <div className="card-body text-center">
            ...
            <p className="m-1 initial-form__insurance-name-short">
              Seguro para Autos
            </p>
            <p className="initial-form__insurance-sentense">
              Para comenzar, cuéntanos sobre ti...
            </p>
        ...
        <div className="w-100 inital-from__box mt-3">
          ...
          {step === 3 && (
            <Step3 formik={formik} setCirculation={setCirculationZone} />
          )}
        </div>
